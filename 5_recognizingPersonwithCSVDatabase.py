...
embeddingModel = "facerecognizeattendance/code/openface_nn4.small2.v1.t7"
...
prototxt = "facerecognizeattendance/code/model/deploy.prototxt"
model = "facerecognizeattendance/code/model/res10_300x300_ssd_iter_140000.caffemodel"
...
while True:
    ...
    for i in range(0, detections.shape[2]):
        ...
        if confidence > conf:
            ...
            proba = preds[j]
            name = le.classes_[j]
            with open('facerecognizeattendance/code/student.csv', 'r') as csvFile:
